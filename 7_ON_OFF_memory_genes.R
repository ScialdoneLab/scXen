...
library(UpSetR)
ONgenes0 <- c(scON_cluster_0_FDR_FC$gene_names)
ONgenes1 <- c(scON_cluster_1_FDR_FC$gene_names)
ONgenes2 <- c(scON_cluster_2_FDR_FC$gene_names)
ONgenes3 <- c(scON_cluster_3_FDR_FC$gene_names)
ONgenes4 <- c(scON_cluster_4_FDR_FC$gene_names)
ONgenes5 <- c(scON_cluster_5_FDR_FC$gene_names)
ONgenes6 <- c(scON_cluster_6_FDR_FC$gene_names)
ONgenes7 <- c(scON_cluster_7_FDR_FC$gene_names)
ONgenes8 <- c(scON_cluster_8_FDR_FC$gene_names)
ONgenes9 <- c(scON_cluster_9_FDR_FC$gene_names)

OFFgenes0 <- c(scOFF_cluster_0_FDR_FC$gene_names)
OFFgenes1 <- c(scOFF_cluster_1_FDR_FC$gene_names)
OFFgenes2 <- c(scOFF_cluster_2_FDR_FC$gene_names)
OFFgenes3 <- c(scOFF_cluster_3_FDR_FC$gene_names)
OFFgenes4 <- c(scOFF_cluster_4_FDR_FC$gene_names)
OFFgenes5 <- c(scOFF_cluster_5_FDR_FC$gene_names)
OFFgenes6 <- c(scOFF_cluster_6_FDR_FC$gene_names)
OFFgenes7 <- c(scOFF_cluster_7_FDR_FC$gene_names)
OFFgenes8 <- c(scOFF_cluster_8_FDR_FC$gene_names)
OFFgenes9 <- c(scOFF_cluster_9_FDR_FC$gene_names)
